...
hl.on("hyprland.start", function ()
  ...
  -- Ensure portals and environment are synced for file associations
...
-- Fix Dolphin "Open With" and extension mapping
...
require("windows.discord")
require("windows.runescape")
require("windows.steam")
